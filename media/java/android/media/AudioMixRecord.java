...
public class AudioMixRecord
{
     ...
     */
    public AudioMixRecord(int sampleRateInHz, int channelConfig, int audioFormat, 
    ...
    throws IllegalArgumentException {   
        ...
        audioParamCheck(sampleRateInHz, channelConfig, audioFormat);
        ...
        int initResult = native_setup( new WeakReference<AudioMixRecord>(this), 
                mSampleRate, mChannels, mAudioFormat, mNativeBufferSizeInBytes,
                session);
    ...
    static public int getMinBufferSize(int sampleRateInHz, int channelConfig, int audioFormat) {
        ...
        default:
            ...
            return AudioMixRecord.ERROR_BAD_VALUE;
        }
    ...
    public interface OnRecordPositionUpdateListener  {
         ...
         */
        void onMarkerReached(AudioMixRecord recorder);
        
        /**
         * Called on the listener to periodically notify it that the record head has reached
         * a multiple of the notification period.
         */
        void onPeriodicNotification(AudioMixRecord recorder);
    }
    ...
    private class NativeEventHandler extends Handler {
        ...
        private final AudioMixRecord mAudioRecord;

        NativeEventHandler(AudioMixRecord recorder, Looper looper) {
            super(looper);
    ...
    private static void postEventFromNative(Object audiorecord_ref,
        ...
        AudioMixRecord recorder = (AudioMixRecord)((WeakReference)audiorecord_ref).get();
        if (recorder == null) {
            return;
        }
    ...
    private native final int native_setup(Object audiorecord_this, 
            int sampleRate, int nbChannels, int audioFormat,
